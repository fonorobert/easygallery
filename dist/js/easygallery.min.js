/* Easygallery v1.0.0 | Copyright 2014 Robert Fonó | MIT License |github.com/fonorobert/easygallery */
...
function thumbSize(){var e=$(".thumb").width();$(".thumb").css("height",e*.625+"px")}$(".swipebox").swipebox({hideBarsOnMobile:false});var thumbCount=$(".thumb").length;$(document).ready(function(){for(;thumbCount>0;thumbCount--){console.log(thumbCount);var e=$("#thumbid"+thumbCount).data("src");console.log(e);$("#thumbid"+thumbCount).css("background-image","url("+e+")")}});$(document).ready(function(){thumbSize()});$(window).resize(function(){thumbSize()})